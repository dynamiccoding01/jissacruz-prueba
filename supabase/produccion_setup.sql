...
-- ----------------------------------------------------------------------------
-- Reproduce el estado actual de la base (scripts 01–34) en un proyecto Supabase
-- NUEVO y VACÍO, en una sola corrida. Concatenación en ORDEN DE DEPENDENCIA
-- (no numérico: 29 antes que 22, 26 antes que 25); las migraciones/backfills
-- quedan como no-ops sobre base vacía.
--
-- USO: 1) crear proyecto vacío  2) pegar y ejecutar TODO una vez  3) crear el
-- primer admin en Supabase Auth con user_metadata { "rol": "admin" }  4) los
-- DATOS se cargan aparte. Si cambia un script del repo, regenerar este archivo.
-- ============================================================================
