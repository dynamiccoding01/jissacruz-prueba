...
// Tope de códigos originales por línea en el PDF (Q6).
const TOPE_OEM = 5
...
const styles = StyleSheet.create({
  ...
  cell: { fontSize: 8 },
  // R14: Detalle más ancho para las líneas de medidas y códigos originales.
  cNum: { width: "4%" },
...
export type VentaItemPdf = {
  ...
  // Sprint 6 (Q5/R14): unidad en Cantidad; medidas y OEM en Detalle.
  unidad: string
  medidas: Medida[]
  originales: string[]
}
